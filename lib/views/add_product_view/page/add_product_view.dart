...
class AddOrUpdateProductScreen extends StatelessWidget {
                    ...
                    children: [
                      ...
                      Center(
                        child: CustomElevatedButton(
                          ...
                          width: 0.85.sw,
                          text: isUpdate
                              ? Lang.of(context).lbl_update_product
  ...
  Widget _buildCommonInputs(BuildContext context, AddProductState state) {
    return Column(
      children: [
        ...
        LabeledTextField(
            label: Lang.of(context).lbl_discount,
  ...
  Widget _buildImageInput(BuildContext context, AddProductState state) {
    return Column(
      ...
      children: [
        Text(
          Lang.of(context).lbl_upload_images,
          style: Theme.of(context).textTheme.bodyLarge,
        ),
